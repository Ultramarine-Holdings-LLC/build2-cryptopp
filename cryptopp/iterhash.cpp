...
template<> IteratedHashBase<word64, HashTransformation>::~IteratedHashBase(){}
template<> IteratedHashBase<word64, MessageAuthenticationCode>::~IteratedHashBase(){}
template<> IteratedHashBase<word32, HashTransformation>::~IteratedHashBase(){}
template<> IteratedHashBase<word32, MessageAuthenticationCode>::~IteratedHashBase(){}
